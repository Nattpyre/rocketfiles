...
class Document
{
    ...
    {
        $images = array('jpg', 'gif', 'png', 'bmp', 'tiff', 'svg');
        $docs   = array('txt', 'rtf', 'doc', 'docx', 'pdf');
        $archives   = array('zip', 'rar', '7z', 'arj', 'cab', 'cbr', 'gz', 'gzip', 'jar', 'tar', 'tar-gz', 'tgz', 'zipx');
        $video  = array('mpg', 'wmv', 'avi', 'mp4', 'm4v', 'webm', 'ogv');
        $audio  = array('wav', 'mp3', 'ogg', 'aac');
