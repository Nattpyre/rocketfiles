...
class GetId3Core
{
    ...
    public function __construct()
    {
        ...
        if (!class_exists('Helpers\\GetId3\\Lib\\Helper')) {
            $this->addStartupError(str_replace('\\', DIRECTORY_SEPARATOR, 'Helpers\\GetId3\\Lib\\Helper').'.php is missing or corrupt');
        }
    ...
    public function GetFileFormat(&$filedata, $filename = '')
    {
        ...
        foreach ($GetFileFormatArray as $format_name => $info) {
            ...
            if (!empty($info['pattern'])
                ...
                $info['class'] = 'Helpers\\GetId3\\Module\\'.Helper::toCamelCase($info['group'], '-', true).'\\'.ucfirst($info['module']);
