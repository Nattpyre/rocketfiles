...
namespace Helpers\GetId3\Write;

use Helpers\GetId3\Lib\Helper;
use Helpers\GetId3\GetId3Core;
use Helpers\GetId3\Module\Tag;
use Helpers\GetId3\Exception\DefaultException;
...
class Tags
{
    ...
    {
        if (!class_exists('Helpers\\GetId3\\GetId3Core')) {
            throw new DefaultException('Helpers\\GetId3\\GetId3Core not available while calling Helpers\\GetId3\\Write\\Tags()');
        }
        if (!class_exists('Helpers\\GetId3\\Lib\\Helper')) {
