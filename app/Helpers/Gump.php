		...
		foreach($this->errors as $e) {
			...
			switch($e['rule']) {
				...
				case 'validate_required':
					$resp[] = "Заполнены не все поля!";
					break;
				case 'validate_valid_email':
					$resp[] = "Введен неверный email";
					break;
				case 'validate_max_len':
					if($param == 1) {
						$resp[] = "Длина поля \"$field\" превышает максимум! ($param)";
					} else {
						$resp[] = "Длина поля \"$field\" превышает максимум! ($param)";
					}
					break;
				case 'validate_min_len':
					if($param == 1) {
						$resp[] = "Длина поля \"$field\" слишком короткая, требуется минимум $param символов.";
					} else {
						$resp[] = "Длина поля \"$field\" слишком короткая, требуется минимум $param символов.";
					}
					break;
				...
				case 'validate_alpha_dash':
					$resp[] = "$field может содержать только латинские буквы, цифры, тире и подчеркивания.";
					break;
				...
				case 'validate_valid_url':
					$resp[] = "Неверный адрес URL.";
					break;
				case 'validate_url_exists':
					$resp[] = "Данный URL не существует.";
					break;
